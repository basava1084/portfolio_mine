...
const Projects = () => {
  ...
  return (
    <section className="relative min-h-screen w-full py-20 md:py-40 px-6">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-24 space-y-4 md:space-y-0">
          <div className="space-y-4">
            <span className="text-[10px] font-mono tracking-[1.5em] text-primary uppercase">[ PROJECT_VAULT ]</span>
            <h2 className="text-5xl md:text-9xl font-black tracking-tighter text-black uppercase">MY<br />PROJECTS</h2>
          </div>
        ...
        <div className="space-y-20 md:space-y-40">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-16 items-center"
            >
              <div className="space-y-6 md:space-y-8 order-2 md:order-1 w-full">
                <div className="space-y-2">
                  ...
                  <h3 className="text-4xl md:text-7xl font-black text-black tracking-tighter group-hover:italic transition-all">
                    {project.title}
                  </h3>
                </div>
                <p className="text-lg md:text-xl text-black/50 font-light leading-relaxed max-w-lg">
                  {project.description}
                </p>
